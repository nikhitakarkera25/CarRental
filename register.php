<?php
    ...
    if(isset($_POST['register_btn']))
    {
        ...
        else
        {
            ...
            if (!preg_match("/([\w\-]+\@[\w\-]+\.[\w\-]+)/",$email) || !preg_match('/^[0-9]{10}$/', $phone) || !preg_match('/^[0-9]{8}$/', $lic_no)) // if email or phone ot licence nubmer are invalid
            {
               header("Location: register.php");
            }
            else
                    ...
                    <div class="login-page-content">
                        <div class="login-form">
                            ...
                            <form  method="post" name="registerForm" onsubmit="return checkall()">
                                ...
                                <div class="log-btn">
                                    <button type="submit" name="register_btn" id="register_btn"><i class="fa fa-check-square"></i> Sign Up</button>
                                </div>
                            </form>
                        </div>
                        <div class="create-ac">
