<?php
    ...
    if (isset ($_POST['submitb']))
    {
        ...
        $location = $_POST['loc'];
        $id = $_POST['cname'];
        $sql2=$sql="UPDATE `car` set status='NA' where car_id=$id";
                        ...
                        <div class="login-page-content">
                            <div class="login-form">
                                <select  class="custom-select" style="width: 100%; margin-bottom: 12px " id="cname" name="cname">
                                    <option value="%" selected>Car - Current Location</option>
                                    <?php
                                       $hostname="localhost";
                                       $database="car rental";
                                       $username="root";
                                       ...
                                       if ($result->num_rows > 0)
                                       {
                                           while($row = $result->fetch_assoc())
                                           {
                                             ...
                                             $city = $row1["city"];
                                             echo "<option value=$car_id>$nm - $city</option>";
                                           }
                                        }
                                    ?>
                                </select>
                                ...
                                <div class="log-btn">
                                    <button type="submit" name="submitb" id="submitb">Delete Car</button>
                                </div>
                            </div>
                        </div>
                    </form>
